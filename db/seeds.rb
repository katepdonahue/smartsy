...
Scraper.new("art-nouveau").grab_pages # most images failing
Scraper.new("post-war-american-art").grab_pages
Scraper.new("post-war-european-art").grab_pages
Scraper.new("renaissance").grab_pages # lots of failing images
...
Scraper.new("impressionism").grab_pages # most images failing
